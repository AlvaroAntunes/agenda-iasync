...
const testimonials = [
  {
    ...
    body: "Reduzi 60% das faltas desde que adquiri o sistema Agenda IASync. A minha recepcionista agora foca no que realmente importa.",
    img: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Dr. Miguel Ferreira",
    body: "Implementei em 3 unidades e o retorno foi imediato. Mais consultas, menos trabalho administrativo.",
  ...
  },
  {
    ...
    body: "Em 2 meses recuperei o investimento anual. A eficiência que ganhamos não tem preço.",
